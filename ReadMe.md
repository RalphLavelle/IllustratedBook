...
## Build
Make sure to be in the _IllustratedBook_ subdirectory:
dotnet build
...
## Sections
The idea of Sections is to allow books to be divided into things other than chapters and pages. For instance, Shakespearean plays have acts and scenes. But that can come later. 